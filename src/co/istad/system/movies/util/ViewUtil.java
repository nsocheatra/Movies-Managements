...
public class ViewUtil {
    ...
    public static void printMovieList(List<Movie> movieList) {
        ...
        while (true) {
            ...
            String choice = InputUtil.getText(Color.YELLOW+"[N]ext   |  [P]revious   |  [E]xit"+Color.RESET).trim().toLowerCase();
    ...
    public static void printBookList(List<Movie> movieList) {
        ...
        while (true) {
            ...
            String choice = InputUtil.getText(Color.YELLOW+"[B]ooking   |  [N]ext   |  [P]revious   |  [E]xit"+Color.RESET).trim().toLowerCase();
            if (choice.equals("b")){
                break;
            }
